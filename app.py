...
BOT_TOKEN = os.getenv("BOT_TOKEN", "7900227246:AAGDCqHjrgz7EfXl3Kicpl68mXQsaDCzhw8")
CHAT_ID = os.getenv("CHAT_ID", "7044424874")
...
def index():
    # Halaman welcome / landing — buat file templates/index.html
